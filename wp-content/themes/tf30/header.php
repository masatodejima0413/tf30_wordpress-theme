...
<head>
	...
	<?php wp_head(); ?>
	<link rel="icon" href="<?php get_template_directory_uri(); ?>/img/icon-home.png">
</head>
...
<body>
	...
	<header id="header">
		<div class="inner">
			...
			<?php else : ?>
				<div class="header-logo"><a href="<?php echo esc_url(home_url()); ?>"><?php bloginfo('name') ?></a></div><!-- /header-logo(//トップページではロゴをh1に、それ以外のページではdivに。) -->
			<?php endif; ?>
			...
			<div class="drawer">
				...
				<div class="drawer-content">
					...
					wp_nav_menu(
						array(
							'depth' => 1,
							'theme_location' => 'drawer', //functionのregisterで設定したやつ
							'container' => 'nav',
							'container_class' => 'drawer-nav', //ulを囲む親要素として.drawer-nav要素が出力される
